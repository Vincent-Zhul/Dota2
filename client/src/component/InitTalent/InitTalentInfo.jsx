            ...
            <div className="InitTalentInfo">
                <div className="InitTalentTitle" style={{
                    ...
                    <div className="InitTalentTitleImage">
                        <img src={`https://dota2server.vercel.app/assets/skills/${talent.InitTalentImage}`} />
                    </div>
                    ...
                    <div className='InitTalentAffectSkill'>
                        <div className='HeroPageInitTalentSkillName' style={{
                            ...
                            {talent.ITAffectSkill1 === '被动技能' ? 
                                <img src={`https://dota2server.vercel.app/assets/skills/${talent.InitTalentImage}`} alt='SkillIcon' style={{width:'9%', margin:'1%'}}/> :
                                <img src={`https://dota2server.vercel.app/assets/skills/${talent.ITAffectSkill1.split(' ')[0]}_icon.webp`} alt='SkillIcon' style={{width:'9%', margin:'1%'}}/>}
